...
SET NEW.total_room_cost = (55.00 * DATEDIFF(NEW.end_date, NEW.start_date)) + 55.00;
ELSEIF name_type_room_value = "double" THEN
SET NEW.total_room_cost = (80.00 * DATEDIFF(NEW.end_date, NEW.start_date)) + 80.00;
ELSEIF name_type_room_value = "twin" THEN
SET NEW.total_room_cost = (80.00 * DATEDIFF(NEW.end_date, NEW.start_date)) + 80.00;
ELSEIF name_type_room_value = "triple" THEN
SET NEW.total_room_cost = (105.00 * DATEDIFF(NEW.end_date, NEW.start_date)) + 105.00;
ELSEIF name_type_room_value = "superior double" THEN
SET NEW.total_room_cost = (110.00 * DATEDIFF(NEW.end_date, NEW.start_date)) + 110.00;
ELSEIF name_type_room_value = "family room" THEN
SET NEW.total_room_cost = (140.00 * DATEDIFF(NEW.end_date, NEW.start_date)) + 140.00;
END IF;
